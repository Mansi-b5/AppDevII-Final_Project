 ...
 * Use the {@link menuDetails#newInstance} factory method to
...
public class menuDetails extends Fragment {
    ...
    public static menuDetails newInstance(String param1, String param2) {
        menuDetails fragment = new menuDetails();
